                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">has_image</label>
                                                <select name="has_image" id="" class="form-control">
                                                    <option value="1" {{ $value->has_image == 1 ? 'selected' : '' }}>
                                                        Image</option>
                                                    <option value="0" {{ $value->has_image == 0 ? 'selected' : '' }}>
                                                        Text</option>
                                                    <option value="2" {{ $value->has_image == 2 ? 'selected' : '' }}>
                                                        Textarea</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">is_config</label>
                                                <select name="is_config" id="" class="form-control">
                                                    <option value="1" {{ $value->is_config == 1 ? 'selected' : '' }}>
                                                        YES</option>
                                                    <option value="0" {{ $value->is_config == 0 ? 'selected' : '' }}>
                                                        NO</option>
                                                </select>
                                            </div>
                                        </div>
