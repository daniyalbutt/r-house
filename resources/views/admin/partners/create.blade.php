...
<div class="container-full">
	<div class="content-header">
	    <div class="d-flex align-items-center">
	        <div class="mr-auto">
	            <h3 class="page-title">{{ $data == null ? 'Add' : 'Update ' }} Partner {{ $data == null ? '' :'#'.$data->id }}</h3>
	            <div class="d-inline-block align-items-center">
	                <nav>
	                    <ol class="breadcrumb">
	                        ...
	                        <li class="breadcrumb-item active" aria-current="page">{{ $data == null ? 'Add' : 'Update ' }} Partner</li>
	                    </ol>
	                </nav>
	            </div>
	        </div>
	            ...
	            <div class="box">
                  @if ($errors->any())
	                ...
	                <div class="box-header with-border">
	                    <h4 class="box-title">{{ $data == null ? 'Upload' : 'Update ' }} Partner Details</h4>
	                </div>
	                <!-- /.box-header -->
	                <form class="form" method="post" action="{{ $data == null ? route('partners.store') : route('partners.update', $data->id) }}" enctype="multipart/form-data">
                	@csrf
...
<div class="form-group{{ $errors->has('logo') ? 'has-error' : ''}}">
    ...
    <input type="file" class="dropify" name="logo" {{ $data != null ? 'data-default-file = ' .asset($data->logo) : ''}}>
