<link rel="stylesheet" href="{{ asset('admin/css/vendors_css.css') }}" type="text/css">
...
<link rel="stylesheet" href="{{ asset('admin/css/jquery.toast.css') }}" type="text/css">
<link rel="stylesheet" href="{{ asset('admin/css/skin_color.css') }}" type="text/css">